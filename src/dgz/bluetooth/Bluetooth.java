...
import dgz.bluetooth.AnimationTabHost;
...
public class Bluetooth extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("Tab3")
        		.setIndicator("车况显示",getResources().getDrawable(android.R.drawable.ic_menu_add))
        		.setContent(new Intent(mContext, dataViewActivity.class))); 
